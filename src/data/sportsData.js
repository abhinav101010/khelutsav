...
export const SPONSORS = [
  ...
  { name: "Nike",      color: "#111111", emoji: "✔️" },
...
export const FAQS = [
  ["Who can participate?",
   "All currently enrolled college students with a valid ID can participate. Students from all years and departments are welcome."],
  ["How many events can I register for?",
   "You can register for up to 3 events. Teams must have a minimum of 5 members for team sports."],
  ["Is there a registration fee?",
   "Nope! Registration is completely free for all students. Just bring your college ID on event day."],
  ["What do I win?",
   "Winners receive trophies, medals, and cash prizes. The overall champion team wins the rolling trophy + ₹50,000 prize pool."],
  ["Can I register on the day?",
   "On-spot registration is available until 8:30 AM but slots are limited — we strongly recommend registering online."],
  ["What should I wear?",
   "Comfortable sportswear and appropriate footwear. Each registered participant gets a free Sports Day 2026 T-shirt."],
  ["Is there food available?",
   "Yes! Multiple food stalls and a hydration station will be set up throughout the day."],
  ["How do I know if I'm confirmed?",
   "After registering, you'll receive a unique registration ID. Keep it saved — you'll need it at the check-in desk."],
];
