  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "4rem 2rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 32 }}>
        {ABOUT_CARDS.map((c, i) => (
          <div key={i} style={{
            background: N.bg, borderRadius: 22, boxShadow: N.shadow, padding: "1.8rem",
          }}>
            <div style={{ fontSize: "2rem", marginBottom: 10 }}>{c.icon}</div>
            <div style={{ fontFamily: "'Righteous', cursive", fontSize: "1.1rem", color: N.text, marginBottom: 8 }}>
              {c.title}
            </div>
      ...
      <div style={{
        ...
        <p style={{ color: N.text2, fontWeight: 600 }}>
          Gates open at 8:00 AM · Main Ground, North Campus · Entry Free for all registered participants
        </p>
      </div>
    </div>
  );
